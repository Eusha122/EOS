...
- **Browser:** `Void` is the privacy browser brand. It must use a Tor-native browsing path. Current E-Browser scaffolding remains in the repo only as a temporary transition layer.
