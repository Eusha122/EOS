...
| Lightweight Plasma desktop | scaffolded | Plasma is selected with Debian 13 package names; cleanup hook removes obvious installer/welcome noise where present, with real EOS theming next. |
